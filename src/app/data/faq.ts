...
export const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Angular, React, Next.js, NestJS, Node.js, MongoDB, and TypeScript, deployed on AWS and GCP. He uses AI tooling (Claude Code, GitHub Copilot, LLM APIs) as a working part of how he designs and ships systems, not a bolt-on.",
  },
  {
